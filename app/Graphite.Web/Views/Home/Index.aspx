...
<%@ Import Namespace="Graphite.Web.Controllers" %>
    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within Graphite.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within Graphite.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open Graphite.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                Graphite.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
